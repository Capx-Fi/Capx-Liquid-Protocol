...
contract Vesting is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    event ProjectInfoVesting(address indexed creator, address indexed tokenAddress);

    event CreateVestVesting(
        uint256 vestID,
    ...
    function lockTokens(
        ...
        emit ProjectInfoVesting(_lockOwner, _tokenAddress);
        uint256 _sumAmount;
