...
contract Master is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    mapping(address => bool) internal _isProject;
    ...
    /// @param _amount uint array Containing only two elements(amount to be wrapped,amount to be locked)
    /// @param _liquid_distAddress Array of Addresses to whom the project owner wants to distribute derived tokens.
    ...
    /// @param _liquid_distAmount Array of amount which determines how much of each derived tokens should be distributed to _liquid_distAddress
    /// @param _liquid_transferable Array of boolean determining which asset is sellable and which is not
    /// @param _vesting_distAddress Array of Addresses to whom the project owner wants to assign the lock to.
    ...
    /// @notice Using this function a user can transfer their vesting lock
    /// @dev Calls VestingController's transferLocks function
    /// @param _id Vest ID of lock
    /// @param _receiverAddress Address which receives the lock
