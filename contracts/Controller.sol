...
contract Controller is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    event TransferWrappedController(
        address userAddress,
    ...
    function tokenTransfer(
        ...
        emit TransferWrappedController(_from, msg.sender, _to, _amount);
    }
    ...
    function withdrawToken(
        ...
        emit WithdrawController(_caller, _amount, _wrappedTokenAddress);
    }
